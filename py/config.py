...
title_key_blacklist=['安全工程师','seo','测试','信息工程师','运维','经理','讲师','教师','老师','负责人','合伙人','计算机技术员','计算机辅助设计','DBA','实施','售前','售后','实习','数据标注员','管培生','2020届大专班','推广员','销售代表']
...
company_id_blocklist=['co5789883','co6033653']
...
#数据
zhinengleibies['7501']='数据分析师'
zhinengleibies['7502']='数据分析经理主管'
zhinengleibies['7503']='ETL开发工程师'
zhinengleibies['7504']='BI工程师'
zhinengleibies['7505']='数据仓库工程师'
zhinengleibies['7506']='数据采集工程师'
zhinengleibies['7507']='数据建模工程师'
zhinengleibies['7508']='数据治理工程师'
zhinengleibies['7509']='数据'
#移动开发
